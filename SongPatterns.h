...
#define num_notes_startsong 3
#define tempo_startsong 200
#define num_notes_exitsong 3
#define tempo_exitsong 200
...
static const uint16_t exitsong[num_notes_exitsong] = {C2, D, E};
static const uint8_t length_note_exitsong[num_notes_exitsong] = {1, 1, 1};

static const uint16_t startsong[num_notes_startsong] = {C, G, C2};
static const uint8_t length_note_startsong[num_notes_startsong] = {1, 1, 1};
